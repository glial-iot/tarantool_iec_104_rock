...
#define REPORTING_DOMAIN_SOCKET_NAME "reporting_domain_socket_name"
...
static struct json_object *master_object_create(struct context *context) {
    ...
    if (context->domain_socket_name) {
        json_object_object_add(master_object, REPORTING_DOMAIN_SOCKET_NAME, json_object_new_string(context->domain_socket_name));
    }
